...
import { InstrumentInfoDao, InstrumentTickerDao, InstrumentCandleDao } from '../dao';
...
export async function handleCandles(message: { table: string; data: Array<{ instrument_id: string; candle: Candle }> }) {
