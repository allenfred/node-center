...
export async function getOkxHistoryKlines(instruments: Instrument[], days?: number): Promise<void> {
  //获取所有时间粒度请求参数 如[60/180/300 900/1800/3600/7200/14400/21600/43200/86400]
  return bluebird.map(
    instruments,
    async (instrument: Instrument) => {
      return await getLatestKlines({ exchange: Exchange.Okex, instId: instrument.instrument_id, count: 500 });
    },
    { concurrency: 2 }
  );
}
